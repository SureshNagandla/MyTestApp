<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="MyTestApp.Pages.Protected.Book.Create" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container mt-4">
        <div class="row">
            <div class="col-8 offset-2">
                <div class="card shadow">
                    <div class="card-header"><h3>Add Book</h3></div>
                    <div class="card-body">
                        ...
                        <a runat="server" id="lnkBack" href="Books.aspx" class="btn btn-secondary">Back</a>
                    </div>
                </div>
            </div>
        </div>
